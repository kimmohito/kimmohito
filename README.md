...
My name is **Kim Mohito**. I'm a [Network Engineer]() graduated under [Cisco]() based in [Kuala Lumpur, Malaysia]() specializing in Web Development (and occasionally designing) expectional websites, applications, and everything in between. I believe in the world of free education where people can discover unlimited resoruce of knowledge without worrying about how much they should spend for the intel. My goal is to always build a products that provide handful methods of inetperating information by sharing.
